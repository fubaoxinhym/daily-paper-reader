...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-08-29 21:20:32 UTC<br>状态：成功</p>
</section>
...
<p>今日速读2篇视觉语言模型论文，暂无精读。</p>
<p>值得关注：VLM空间推理未必依赖显式目标定位，但检索头机制揭示了视觉信息提取路径。</p>
<p>建议先补看这两篇6分论文，后续可深入对比实验与评测细节。</p>
  </div>
</section>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Grounding Isn&#x27;t Knowing: Do VLMs Need Object Localization for Spatial Reasoning?">Grounding Isn&#x27;t Knowing: Do VLMs Need Object Localization for Spatial Reasoning?</span></li><li><span class="dpr-home-dashboard-paper-title" title="Retrieval Heads Meet Vision: Uncovering How VLMs Locate and Extract Visual Information">Retrieval Heads Meet Vision: Uncovering How VLMs Locate and Extract Visual Information</span></li></ul>
  </div>
