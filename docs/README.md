...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-08-29 03:14:37 UTC<br>状态：成功</p>
</section>
...
<p>今日精读0篇、速读1篇，聚焦视觉语言模型的信息提取机制。</p>
<p>最值得关注：论文《Retrieval Heads Meet Vision》揭示VLM如何定位与提取视觉信息，评分6.0/10。</p>
<p>建议后续关注该方向更深入实验，或补读相关对比研究以形成全面认识。</p>
  </div>
</section>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Retrieval Heads Meet Vision: Uncovering How VLMs Locate and Extract Visual Information">Retrieval Heads Meet Vision: Uncovering How VLMs Locate and Extract Visual Information</span></li></ul>
  </div>
